...
# Initialize communication channel and CW jammer
channel = ADSBChannel()
...
def update(frame):
    active_drones = False
    jammer.jamming_probability = min(1.0, frame / 100)  # Gradually increase jamming effect
    jammer.noise_intensity = min(1.0, frame / 100)  # Gradually increase noise intensity
